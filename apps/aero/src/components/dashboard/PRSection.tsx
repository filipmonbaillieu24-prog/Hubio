      ...
      <div style={{ display: 'flex', gap: 8, background: 'rgba(255,255,255,0.02)', padding: 4, borderRadius: 8, border: '1px solid rgba(255,255,255,0.04)', width: 'fit-content' }}>
        <button
          ...
          style={{
            ...
            background: activeTab === 'conditie' ? 'rgba(203, 213, 225, 0.1)' : 'transparent',
            color: activeTab === 'conditie' ? '#cbd5e1' : '#94a3b8',
        ...
        <button
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 11, fontWeight: 700,
            background: activeTab === 'vermogen' ? 'rgba(203, 213, 225, 0.1)' : 'transparent',
            color: activeTab === 'vermogen' ? '#cbd5e1' : '#94a3b8',
            transition: 'all 0.15s',
            fontFamily: 'inherit'
          }}
        >
        ...
        <button
          ...
          style={{
            display: 'flex', alignItems: 'center', gap: 6, padding: '6px 12px', border: 'none', borderRadius: 6, cursor: 'pointer', fontSize: 11, fontWeight: 700,
            background: activeTab === 'klims' ? 'rgba(203, 213, 225, 0.1)' : 'transparent',
            color: activeTab === 'klims' ? '#cbd5e1' : '#94a3b8',
            transition: 'all 0.15s',
            fontFamily: 'inherit'
          }}
        >
