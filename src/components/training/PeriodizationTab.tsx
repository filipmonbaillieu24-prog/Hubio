        ...
        <div style={{ background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 10, overflow: 'hidden' }}>
          ...
          {weekTSSgoal > 0 && (
            <div style={{ padding: '6px 14px', borderBottom: '1px solid rgba(255,255,255,0.04)', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              <div style={{ flex: 1, height: 4, background: 'rgba(255,255,255,0.06)', borderRadius: 2 }}>
                <div style={{ height: '100%', width: `${Math.min(100, (weekTSSactual / weekTSSgoal) * 100).toFixed(0)}%`, background: `linear-gradient(90deg, ${phase.color}, #00e5ff)`, borderRadius: 2, transition: 'width 0.5s' }} />
              </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(7, 1fr)' }}>
            {days2.map((day, i) => {
              ...
              return (
                <div key={day} style={{ padding: '10px 4px', textAlign: 'center', borderRight: i < 6 ? '1px solid rgba(255,255,255,0.04)' : 'none', background: rideInfo2 ? 'rgba(57,255,20,0.05)' : isToday2 ? `${phase.color}08` : 'transparent' }}>
                  ...
                  {rideInfo2 ? (
                    <>
                      ...
                      <div style={{ fontSize: 8, fontWeight: 700, color: '#39ff14' }}>{rideInfo2.distance.toFixed(0)}km</div>
