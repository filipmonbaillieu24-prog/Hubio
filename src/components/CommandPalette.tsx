  ...
  return (
    <>
      ...
      <div style={{
        ...
        borderRadius: 16,
        boxShadow: '0 24px 64px rgba(0,0,0,0.65), 0 0 0 1px rgba(165, 180, 252,0.06)',
        overflow: 'hidden',
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          padding: '8px 14px',
                          cursor: 'pointer',
                          background: isActive ? 'rgba(165, 180, 252,0.07)' : 'transparent',
                      ...
                      >
                        ...
                        <div style={{
                          width: 30, height: 30,
                          borderRadius: 8,
                          background: isActive ? 'rgba(165, 180, 252,0.1)' : 'rgba(255,255,255,0.04)',
