        ...
        <div style={{ display: 'flex', gap: '4px', background: 'rgba(255,255,255,0.02)', padding: '3px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.04)', width: 'fit-content' }}>
          {([
            ...
            <button
              ...
              style={{
                background: timeRange === opt.value ? 'rgba(0, 229, 255, 0.12)' : 'transparent',
                border: 'none',
                color: timeRange === opt.value ? '#00e5ff' : '#94a3b8',
                fontSize: '10px',
                fontWeight: 600,
                padding: '4px 10px',
                borderRadius: '6px',
        ...
        <div style={{ display: 'flex', gap: '14px' }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
            <div style={{ position: 'relative', width: '36px', height: '36px' }}>
              ...
              <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '9px', fontWeight: 700, color: '#00e5ff' }}>
