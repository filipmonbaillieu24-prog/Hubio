...
function DeltaBadge({ current, previous, higherIsBetter = true }: {
  ...
  if (previous === 0) return <span style={{ color: '#39ff14', fontSize: 10, fontWeight: 700 }}>Nieuw!</span>;
  ...
  return (
    <span style={{ color: isPositive ? '#39ff14' : '#ff7675', fontSize: 10, fontWeight: 700 }}>
...
export const WeekOverview: React.FC<Props> = ({ rides }) => {
  ...
  return (
    <div style={{
      background: 'linear-gradient(135deg, rgba(0,229,255,0.04) 0%, rgba(255,255,255,0.01) 100%)',
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <div>
          <div style={{ fontSize: 10, fontWeight: 800, color: '#00e5ff', textTransform: 'uppercase', letterSpacing: '0.8px' }}>
            📅 Deze Week
          </div>
