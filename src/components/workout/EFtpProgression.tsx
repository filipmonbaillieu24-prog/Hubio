      ...
      <div className="wd-section-card">
        <div className="wd-section-card__head">
          <span className="wd-section-card__title">
            <Award size={13} style={{ display: 'inline', verticalAlign: 'middle', marginRight: 5, color: '#00e5ff' }} />
    ...
    <div className="wd-section-card">
      <div className="wd-section-card__head" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <span className="wd-section-card__title" style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
          <Award size={13} style={{ color: '#00e5ff' }} />
          eFTP Progressie
        </span>
        ...
        <div style={{ display: 'flex', gap: 4 }}>
          <button 
            ...
            style={{
              background: viewMode === 'watts' ? 'rgba(0, 229, 255, 0.12)' : 'rgba(255,255,255,0.02)',
              border: `1px solid ${viewMode === 'watts' ? 'rgba(0, 229, 255, 0.25)' : 'rgba(255,255,255,0.08)'}`,
              color: viewMode === 'watts' ? '#00e5ff' : '#94a3b8',
              fontSize: '9px',
              fontWeight: 700,
              padding: '3px 8px',
              borderRadius: '4px',
          ...
          <button 
            ...
            style={{
              background: viewMode === 'wkg' ? 'rgba(0, 229, 255, 0.12)' : 'rgba(255,255,255,0.02)',
              border: `1px solid ${viewMode === 'wkg' ? 'rgba(0, 229, 255, 0.25)' : 'rgba(255,255,255,0.08)'}`,
              color: viewMode === 'wkg' ? '#00e5ff' : '#94a3b8',
              fontSize: '9px',
              fontWeight: 700,
              padding: '3px 8px',
              borderRadius: '4px',
