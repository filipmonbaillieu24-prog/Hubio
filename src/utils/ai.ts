...
export async function sendAIChat(
  ...
  const systemMessage: AIChatMessage = {
    role: 'system',
    content: `${systemContext}\nJe bent een professionele wielercoach genaamd Cyclo Coach. Geef korte, duidelijke en wetenschappelijk onderbouwde antwoorden in het Nederlands. Gebruik geen emojis in je antwoord.`,
  };
