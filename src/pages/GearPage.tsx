              ...
              <div className="gp-card-header">
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
                  <div className="gp-bike-icon-box">
                    <Bike size={22} style={{ color: '#00e5ff' }} />
                  </div>
                  <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
                  ...
                  {g.components.some(c => c.installedAt > 0) && (
                    <button
                      ...
                      style={{ background: 'rgba(0,229,255,0.07)', borderColor: 'rgba(0,229,255,0.25)', color: '#00e5ff', fontSize: 10 }}
                      ...
                      <div key={c.id} className="gp-comp-item">
                        ...
                        <div className="gp-progress-bg">
                          <div
                            ...
                            style={{
                              width: `${pct}%`,
                              background: isLimit ? 'linear-gradient(90deg, #ff7675, #d63031)' : 'linear-gradient(90deg, #00e5ff, #00b894)'
                            }}
                          />
                        </div>
